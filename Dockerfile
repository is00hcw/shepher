...
#COPY ./shepher-packaging/target/shepher-packaging-1.0-bin/lib/*.jar $SHEPHER_HOME/lib/
#COPY ./shepher-packaging/target/shepher-packaging-1.0-bin/bin/wait-for-it.sh $SHEPHER_HOME
#COPY ./shepher-packaging/target/shepher-packaging-1.0-bin/conf/* $SHEPHER_HOME/conf/
